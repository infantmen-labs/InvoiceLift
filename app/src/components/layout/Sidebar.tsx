...
export function Sidebar({ toggle }: toggleMenu){
      ...
      <div className="border-t border-slate-800 px-4 py-3 text-[11px] text-slate-400">
        ...
        <div className="mt-3">
          ...
          <div className="mt-1 flex items-center justify-between gap-2">
            ...
            <span className="whitespace-nowrap rounded-full border border-slate-600 px-2 py-0.5 text-[10px] uppercase tracking-wide text-slate-200 animate-jump">
