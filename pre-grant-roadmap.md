# InvoiceLift — Pre-Grant Roadmap & Reference Repo Skeleton

> Purpose: a concise, grant-ready pre-launch roadmap plus a reference repository skeleton (files + minimal content) you can clone and use to produce the Proof-of-Work the Finternet grant reviewers want.
...
* **Grant goal**: produce an end-to-end devnet demo (mint → fund → settle) + public repo, demo video, and docs that demonstrate technical feasibility and a compliance path.
* **Deliverables for grant**: repo + demo script + 2–3 min video + tx links + technical spec + security plan + weekly public updates.

---

# Pre-Grant Roadmap (phase-based — *do not specify dates in the grant*)

> Each phase lists *deliverables* you will attach to the grant application or produce as Proof-of-Work.
...
* Estimated budget & resource split (see grant guidance).

**Why this matters:** Grant reviewers triage proposals quickly — clarity, PoW, and a realistic milestone plan win.
